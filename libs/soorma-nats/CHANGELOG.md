...
### Changed
- Version alignment: bumped to 0.9.1 (shared infrastructure client synchronized with monorepo release)

## [0.9.0] - 2026-04-17

### Changed
- Version alignment: bumped to 0.9.0 (shared infrastructure client synchronized with monorepo release)
