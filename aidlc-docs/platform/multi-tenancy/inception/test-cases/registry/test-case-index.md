...
|---|---|---|---|---|
| TC-R-001 | Alembic migration converts UUID to VARCHAR(64) on all three tables | registry / FR-2.1, FR-2.2 | happy-path | High |
...
| TC-R-006 | Registry ORM models use String(64) for tenant_id | registry / FR-2.3, FR-2.4, FR-2.5 | happy-path | High |
...
| TC-R-009 | Registry does not leak data across platform tenant namespaces | registry / NFR-1.3 | happy-path-negative | High |
