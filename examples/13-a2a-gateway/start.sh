...
echo "============================================================"
echo ""
echo "Test with the client driver (recommended):"
echo "  python client.py              # Full demo: show card + send 3 tasks"
echo "  python client.py card         # View the A2A Agent Card"
echo "  python client.py send \"Research quantum computing\"  # Send a single task"
echo ""
