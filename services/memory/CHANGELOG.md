...
### Changed
- Version alignment: bumped to 0.9.1 (memory service synchronized with monorepo release)

## [0.9.0] - 2026-04-17

### Changed
- Version alignment: bumped to 0.9.0 (memory service synchronized with monorepo release)
...
- No functional changes to memory service
