...
class TestSemanticMemoryServiceIngest:
    ...
    async def test_ingest_success(self):
        ...
        mock_memory.platform_tenant_id = TEST_PLATFORM_TENANT_ID
        mock_memory.service_user_id = TEST_SERVICE_USER_ID
        ...
        with patch('memory_service.crud.semantic.upsert_semantic_memory',
            ...
            response = await service.ingest(mock_db, TEST_PLATFORM_TENANT_ID, TEST_SERVICE_TENANT_ID, TEST_SERVICE_USER_ID, data)
...
class TestSemanticMemoryServiceSearch:
    ...
    async def test_search_returns_crud_results(self):
        ...
        mock_results = [
            SemanticMemoryResponse(
                id=str(uuid4()),
                tenant_id=TEST_PLATFORM_TENANT_ID,
                user_id=TEST_SERVICE_USER_ID,
        ...
        with patch('memory_service.crud.semantic.search_semantic_memory',
            ...
            results = await service.search(mock_db, TEST_PLATFORM_TENANT_ID, TEST_SERVICE_TENANT_ID, TEST_SERVICE_USER_ID, query, limit)
    ...
    async def test_search_empty_results(self):
        ...
        with patch('memory_service.crud.semantic.search_semantic_memory',
            ...
            results = await service.search(mock_db, TEST_PLATFORM_TENANT_ID, TEST_SERVICE_TENANT_ID, TEST_SERVICE_USER_ID, "nonexistent", 5)
    ...
    async def test_search_with_limit_1(self):
        ...
        with patch('memory_service.crud.semantic.search_semantic_memory',
            ...
            results = await service.search(mock_db, TEST_PLATFORM_TENANT_ID, TEST_SERVICE_TENANT_ID, TEST_SERVICE_USER_ID, "test", limit=1)
    ...
    async def test_search_preserves_scores_order(self):
        ...
        mock_results = [
            SemanticMemoryResponse(
                id=str(uuid4()), tenant_id=TEST_PLATFORM_TENANT_ID,
                user_id=TEST_SERVICE_USER_ID,
                content="High score", 
                external_id=None,
                is_public=False,
        ...
        with patch('memory_service.crud.semantic.search_semantic_memory',
                   new_callable=AsyncMock, return_value=mock_results):
            results = await service.search(mock_db, TEST_PLATFORM_TENANT_ID, TEST_SERVICE_TENANT_ID, TEST_SERVICE_USER_ID, "test", 3)
