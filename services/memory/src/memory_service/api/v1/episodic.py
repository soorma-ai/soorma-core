...
async def log_episodic_memory(
    ...
    memory = await create_episodic_memory(db, tenant_id, user_id, data)
...
async def get_recent_history(
    ...
    results = await get_recent_episodic_memory(db, tenant_id, user_id, agent_id, limit)
    return results
...
async def search_episodic(
    ...
    results = await search_episodic_memory(db, tenant_id, user_id, agent_id, q, limit)
    return results
