...
### Changed
- Version alignment: bumped to 0.9.1 (registry service synchronized with monorepo release)

## [0.9.0] - 2026-04-17

### Changed
- Version alignment: bumped to 0.9.0 (registry service synchronized with monorepo release)
